  ...
  return (
    <Shell selectedCity={selectedCity} onCityChange={setSelectedCity}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {/* 1. HERO CHART: CORRELATION ANALYSIS (Full Width) */}
        <div className="col-span-1 md:col-span-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm flex flex-col min-w-0">
        ...
        {/* 3. FORECAST (Bottom Row) */}
        <div className="col-span-1 md:col-span-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
